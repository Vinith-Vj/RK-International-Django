$(function() {
    ...
    $(window).on('scroll', function (event) {
        ...
        if (scroll < 20) {
            ...
            // $(".header_navbar img").attr("src", staticUrl);
        } else {
    ...
    //     if (scroll < 20) {
    //         // Remove sticky class and set the default image
    //         $(".header_navbar").removeClass("sticky");
    //         $(".header_navbar img").attr("src", "static/images/RK_International_background.png");
    //     } else {
    //         // Add sticky class and change the image
    //         $(".header_navbar").addClass("sticky");
    //         $(".header_navbar img").attr("src", "static/images/RK_International_sticky.png");
    //     }
    // });
